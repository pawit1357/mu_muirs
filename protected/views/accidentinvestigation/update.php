...
<form id="Form1" method="post" enctype="multipart/form-data"
	...
	<div class="portlet light">
		...
		<div class="portlet-body form">
			...
			<option value="<?php echo $item->id?>" <?php echo ($item->id == $data->person_department_id? 'selected="selected"':'')?>><?php echo (($item->faculty_id < 0)? '' : '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- '). $item->name?></option>
			<?php }?>
			</select>
										...
										<div class="col-md-8">
											<table>
												...
												<tr>
													...
													<td><input type="text" value="<?php echo $data->accidental_damage1?>" id="accidental_damage1" class='allowNum' style="border: none; border-bottom-style: dotted; width: 150px;" name="AccidentInvestigation[accidental_damage1]" /></td>
													<td>ราย</td>
												</tr>
												...
												<tr>
													...
													<td><input type="text" value="<?php echo $data->accidental_damage4?>" id="accidental_damage4" class='allowNum'
														style="border: none; border-bottom-style: dotted; width: 150px;"
