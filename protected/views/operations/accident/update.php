							...
							<div class="row">
								<div class="col-md-10">
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" value="<?php echo $data->position_or_level?>" id="position_or_level"
							...
							<div class="row">
								<div class="col-md-10">
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" value="<?php echo $data->phone_number?>" id="phone_number"
							...
							<div class="row">
								<div class="col-md-10">
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" value="<?php echo $data->email?>" id="email" class="form-control"
												name="Accident[email]" />
										</div>
							...
							<div class="row">
								<div class="col-md-10">
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" value="<?php echo $data->name2?>" id="name2" class="form-control"
												name="Accident[name2]" />
										</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<textarea rows="5" cols="70" id="accident_event"
												name="Accident[accident_event]"><?php echo $data->accident_event?></textarea>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<textarea rows="5" cols="70" id="accident_cause"
												name="Accident[accident_cause]"><?php echo $data->accident_cause?></textarea>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<textarea rows="5" cols="70" id="accident_solve"
												name="Accident[accident_solve]"><?php echo $data->accident_solve?></textarea>
										...
										<div class="col-md-8">
											<table>
												<tr>
													...
													<td>&nbsp;&nbsp; <input type="text" value="<?php echo $data->dammage_type_1_value?>" class='allowNum'
												...
												<tr>
													...
													<td>&nbsp;&nbsp; <input type="text" value="<?php echo $data->dammage_type_2_value?>" class='allowNum'
												...
												<tr>
													...
													<td>&nbsp;&nbsp; <input type="text" value="<?php echo $data->dammage_type_3_value?>" class='allowNum'
												...
												<tr>
													...
													<td>&nbsp;&nbsp; <input type="text" value="<?php echo $data->dammage_type_4_value?>" class='allowNum2'
												...
												<tr>
													...
													<td><input type="text" value="<?php echo $data->dammage_type_5_value?>" id="dammage_type_5_value" class='allowNum'
														style="border: none; border-bottom-style: dotted; width: 80px;text-align: right;"
