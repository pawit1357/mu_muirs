				...
				<div class="row">
					<div class="col-md-9">
						<div class="form-group">
							...
							<div class="col-md-6">
<select class="form-control" name="AccidentInvestigation[owner_department_id]" id="owner_department_id" onchange="onchangeDepartment(this)" <?php echo UserLoginUtils::isAdmin()? '"':'disabled="disabled'?>>
							...
							<div class="col-md-6">
									<div class="input-group date date-picker"
										...
										<input type="text"
											...
											name="AccidentInvestigation[report_date_from]" /> <span
							...
							<div class="col-md-6">
											<div class="input-group date date-picker"
												...
												<input type="text"
													...
													name="AccidentInvestigation[report_date_to]" /> <span
													class="input-group-btn">
													<button class="btn default" type="button">
														<i class="fa fa-calendar"></i>
													</button>
...
<a href="<?php echo Yii::app()->CreateUrl('Report/Report02Pdf/owner_department_id/'.$data->owner_department_id.'/report_date_from/'.(($data->report_date_from =='')?  CommonUtil::getDate(CommonUtil::getCurDate()) : CommonUtil::getDate($data->report_date_from)).'/report_date_to/'.(($data->report_date_to =='')? CommonUtil::getDate(CommonUtil::getCurDate()) :  CommonUtil::getDate($data->report_date_to)))?>" class="btn btn-primary btn-lg" role="button">Download (PDF)</a>
