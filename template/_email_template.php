											...
											<tbody>
												<tr>
													<td valign="top">
														...
														style="font-weight: bold"><?php echo $_GET['labCode']; ?></font>
														<br></br> <font color='green'>
														<?php if( isset($_GET['fac'])){?>
														(&nbsp;
														<?php }?>
														<?php echo $_GET['fac']; ?>
														<?php echo $_GET['dep']; ?>
							...
							<tbody>
								<tr>
									<td valign="top" style="font-size: 12px; padding: 20px;">
										...
										<a
										href="http://localhost:81/labbase/index.php/LabRegister/Result1/user_id/<?php echo $_GET['user_id']?>/pwd/<?php echo $_GET['pwd']?>">Click</a>
